...
class Fajr extends StatefulWidget {
  const Fajr({Key? key}) : super(key: key);
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          Solatan(
              ...
              rus: nukaddimuRU,
              isArab: isArabic),
          Counter(max: 10, ar: shahaadaAR, isArabic: isArabic, ru: shahaadaRU),
          Solatan(
              bis: false,
              arab: uaIlayhilAR,
              rus: uaIlayhilRU,
          ...
          Nav(textRu: azhirnaDeskRU, isArabic: isArabic, textAr: azhirnaDeskAR),
          Solatan(
              bis: false,
              arab: azhirnaLongAR,
              rus: azhirnaLongRU,
          ...
          Solatan(
              bis: false, isArab: isArabic, arab: biawfikaAR, rus: biawfikaRU),
          Counter(max: 3, ar: maalAbrorAR, isArabic: isArabic, ru: maalAbrorRU),
          Solatan(
          ...
          Solatan(
              bis: false, arab: MuhammadAR, rus: MuhammadRU, isArab: isArabic),
          Counter(
              max: 10,
              isArabic: isArabic,
              ar: afterMuhammadAR,
          ...
          divider(),
          Solatan(
              bis: false, isArab: isArabic, arab: alfuAlfiAR, rus: alfuAlfiRU),
          divider(),
          Solatan(
              bis: false,
              isArab: isArabic,
